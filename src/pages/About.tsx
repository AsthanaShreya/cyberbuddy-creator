...
const teamMembers = [
  { name: 'Project Lead', role: 'Full Stack Development', avatar: '👨‍💻' },
  { name: 'ML Engineer', role: 'AI Model Development', avatar: '🤖' },
  { name: 'Blockchain Dev', role: 'Web3 & IPFS Integration', avatar: '⛓️' },
  { name: 'Security Analyst', role: 'Threat Research', avatar: '🔒' },
];
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { name: 'Solidity + Web3.js', desc: 'Smart Contracts' },
            { name: 'IPFS + Pinata', desc: 'Decentralized Storage' },
            { name: 'Scikit-learn / TensorFlow', desc: 'ML Models' },
            { name: 'Polygon Testnet', desc: 'Blockchain Network' },
